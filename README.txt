The Clipper library - float version.
...
This repository is a fork of the sandbox version from svn repository
https://svn.code.sf.net/p/polyclipping/code/sandbox. 
Clipper2 (alpha) sources are kept in a separate branch.
